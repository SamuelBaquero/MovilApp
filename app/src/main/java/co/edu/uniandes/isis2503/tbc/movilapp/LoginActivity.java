...
public class LoginActivity extends AppCompatActivity{
    ...
    public final static String USER_ID = "co.edu.uniandes.isis2503.tbc.USER_ID";
     ...
     */
    public void mostrarReservas(String email, String cedulaC, Long userID){
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                mostrarReservas(mEmail, mCC, mID);
            } else {
